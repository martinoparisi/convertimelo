  ...
  template: `
    ...
    >
      ...
      >
        ...
        <div
          class="inline-block align-bottom bg-slate-900 rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6 border border-indigo-500/30"
        >
                ...
                <div class="flex items-center space-x-4">
                  ...
                  <div class="flex-1">
                    ...
                    <input
                      ...
                      id="email"
                      class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-600 bg-slate-800 text-white rounded-md p-3"
                      placeholder="email"
                    />
                  </div>
                </div>
